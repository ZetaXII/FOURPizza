...
<nav class="navbar navbar-expand-md navbar-light fixed-top bg-light border-bottom">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
         <ul class="navbar-nav">
    		...
    		<li class="nav-item">
      			<a class="nav-link" href="homeCameriere.php">Home</a>
    		</li>            
            <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">Ordini</a>
                  <div class="dropdown-menu">
                    <a class="nav-link" href="selezionaTavolo.php"><img src="../img/addOrdine.svg" style="width:20px; height:20px;"/> Nuovo</a>
            ...
            <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="nav-link" href="infoCameriere.php"><img src="../img/info.svg" style="width:20px; height:20px;"/> Info personali</a>
