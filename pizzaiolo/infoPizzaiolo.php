	...
	if($_SESSION['ruolo']=="P")
    {
    	...
    	if(isset($_POST['modifica']))
        {
          ...
          if($controllaEmail->num_rows>=1)
          {
			 ...
			 echo "&nbsp;<a href='infoPizzaiolo.php'><button class='btn btn-danger' style='margin:10px auto;'>Indietro</button></a>
          ...
          else if($_FILES['img']['tmp_name']!=NULL && $imgCanc!='on')
          {
            ...
            if($grandezzaImg<=64)
            {
              ...
              $_SESSION['immagine']=$immagine;
          	  header("location: homePizzaiolo.php");                              
            }
            else
            {
              include("navPizzaiolo.php");
...
?>				
                ...
                <form action="#" method="post" enctype="multipart/form-data">
                	<table class="text-left" style="margin: 0px auto !important;">
                    	...
                    	<tr><th>Ruolo</th>        
                        <td><input type="radio" class="radio-inline" value="A" disabled>&nbsp;Admin&nbsp;<input type="radio" value="P" checked="checked" disabled>&nbsp;Pizzaiolo&nbsp;<input type="radio" value="C" disabled>&nbsp;Cameriere</td></tr>				
