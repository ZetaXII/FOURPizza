...
?>
		<div class="container">
        	<div class="row">
            	<div class="col">
					<br/><h1 class="text-center">ORDINI IN CONSEGNA</h1><br/>                    
<?php
...
?>
            	...
            	<tr class="bg-dark text-white"><th colspan="9">ORDINI TAVOLO N° <?php echo $rigaT->numTavolo ?></th></tr>
<?php
				$queryO="SELECT * FROM ordini WHERE stato=2 AND tavolo=".$rigaT->idTavolo." ORDER BY ora ASC";
                $selezionaO=$db->query($queryO);
                if($selezionaO->num_rows>0)
                {     
?>					                     
                	<tr><th>Pietanza</th><th>Qt.</th><th>Note</th><th>Cameriere</th><th>Data</th><th>Ora</th><th colspan="3">Azioni</th></tr>   
<?php                   
...
?>
                            <tr><td><?php echo $rigaM->nomeMenu; ?></td><td><?php echo $rigaO->quantita." pz."; ?></td><td><?php echo $note; ?></td><td><?php echo $rigaS->nome." ".$rigaS->cognome; ?></td><td><?php echo $rigaO->data; ?></td><td><?php echo $rigaO->ora; ?></td><td><?php echo"<a href='cancellaOrdine.php?id=$rigaO->idOrdine'><p style='color:#C12020;'><img src='../img/bin.svg' style='width:20px;height:20px;'/>&nbsp;Cancella</p></a>";?></td><td><?php echo"<a href='ripreparaOrdine.php?id=$rigaO->idOrdine'><p style='color:#FFCE00;'><img src='../img/riprepara.svg' style='width:20px;height:20px;'/>&nbsp;Riprepara</p></a>";?></td><td><?php echo"<a href='completaOrdine.php?id=$rigaO->idOrdine'><p style='color:#32BEA6;'><img src='../img/tick.svg' style='width:20px;height:20px;'/>&nbsp;Completa</p></a>";?></td></tr>
<?php
                          }
                      	}
                        else
